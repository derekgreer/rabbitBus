...
{
	public abstract class ConsumeConfigurationConventionBase : IConsumeConfigurationConvention
	{
		...
		public ushort GetQualityOfService(Type type)
		{
			return 0;
		}

		public IDeadLetterConfiguration GetDeadLetterConfiguration(Type type)
		{
			return null;
		}
	}
